                ...
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between text-xs mb-2">
                      <span className="text-[#629FAD] font-semibold">Questions Answered</span>
                      <span className="text-[#EDEDCE]">{questionCount}</span>
                    </div>
                    <div className="w-full h-2 bg-[#296374]/30 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-linear-to-r from-[#629FAD] to-[#296374] transition-all duration-300"
